...
public class XImage {
    ...
    public static Image getAppIcon() {
        URL url = XImage.class.getResource("/com/phone/logo/MainLogo.jpg");
...
File dst = new File("src\\main\\resources\\com\\phone\\logo", src.getName());
    ...
    public static ImageIcon read(String fileName) {
        File path = new File("src\\main\\resources\\com\\phone\\logo", fileName);
